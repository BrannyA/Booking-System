...
select T3.Train_ID,T2.T_date,T3.stationNum,T3.Stationname
...
from (
        ...
        and Ticket.T_date=
							...
							case when P2.P_DAY=0 then '2020-5-1'

								when P2.P_DAY=1 then '2020-5-1'::date+ INTERVAL'1 day'

								when P2.P_DAY=2 then '2020-5-1'::date+ INTERVAL'2 day'
