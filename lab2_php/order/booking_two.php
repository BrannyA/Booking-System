	...
	<div class="container">
		<div class="box1">
			<?php
				...
				echo "<br>用户$username ，您的两个订单信息如下<br>";
				echo "<br>订单1";
				echo "<br>订单号： $R_ID";
				echo "<br>车次： $Train_ID";
				echo "<br> $date_1 ，从$departure_station 到$arrive_station";
				echo "<br>座位是$seat1 ，价格$price1 元<br>";

				echo "<br>订单2";
				echo "<br>订单号： $R_ID2";
				echo "<br>车次： $Train_ID2";
				echo "<br> $date_2 ，从$departure_station2 到$arrive_station2";
				echo "<br>座位是$seat2 ， 价格$price2 元";
			...
			<br>
			<button type="button"><a  onclick="location.href='service_8.php'"><h4>查询订单</h4></a></button>
			<br>
			<button type="button"><a  onclick="location.href='../home/index.php'"><h2>退出登录</h2></a></button>

			<br>
			<button type="button"><a  onclick="location.href='../home/service.php'"><h2>返回服务页</h2></a></button>
			<br>
			<button type="button"><a  onclick="location.href='../home/service_4.php'"><h2>返回需求4查找页</h2></a></button>
	    </div>
	</div>
</body>
</html>
