    ...
    <div class="container">
		<div class="box1">
            <?php
                ...
                echo "<br>用户 $username ， 您要取消的订单信息如下：";
                echo "<br>订单号： $R_ID";
                echo "<br>$date 从$departure_station 到$arrive_station 的火车$Train_ID";
                echo "<br>座位是： $Seattype";
            ...
            <button type="button"><a  onclick="location.href='service_8.php'"><h3>返回需求8查找页</h3></a></button>
        </div>
	</div>
</body>
</html>
